...
Mesh* Mesh::GenerateTriangle() {
	Mesh*m = new Mesh();
	m->numVertices = 3; // for more tringle = 3*x
	...
	m->vertices[13] = Vector3(0.5f, -0.5f, 0.0f);
	m->vertices[14] = Vector3(-0.5f, -0.5f, 0.0f);

	m->vertices[15] = Vector3(0.0f, 0.5f, 0.0f);
	m->vertices[16] = Vector3(0.5f, -0.5f, 0.0f);
	m->vertices[17] = Vector3(-0.5f, -0.5f, 0.0f);

	m->vertices[18] = Vector3(0.0f, 0.5f, 0.0f);
	m->vertices[19] = Vector3(0.5f, -0.5f, 0.0f);
	m->vertices[20] = Vector3(-0.5f, -0.5f, 0.0f);

	m->vertices[21] = Vector3(0.0f, 0.5f, 0.0f);
	m->vertices[22] = Vector3(0.5f, -0.5f, 0.0f);
	m->vertices[23] = Vector3(-0.5f, -0.5f, 0.0f);

	m->vertices[24] = Vector3(0.0f, 1.f, 0.0f);
	m->vertices[25] = Vector3(1.f, -1.f, 0.0f);
	m->vertices[26] = Vector3(-1.f, -1.f, 0.0f);

	m->vertices[27] = Vector3(0.0f, 0.5f, 0.0f);
	m->vertices[28] = Vector3(0.5f, -0.5f, 0.0f);
	m->vertices[29] = Vector3(-0.5f, -0.5f, 0.0f);
	...
	*/
	...
	m->colours[6] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[7] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[8] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m->colours[9] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[10] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[11] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m->colours[12] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[13] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[14] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m->colours[15] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[16] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[17] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m->colours[18] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[19] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[20] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m->colours[21] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[22] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[23] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m->colours[24] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[25] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[26] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m->colours[27] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	m->colours[28] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[29] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);
...
void Mesh::BufferData() {
	...
	glBufferData(GL_ARRAY_BUFFER, numVertices * sizeof(Vector3), vertices, GL_STATIC_DRAW); // square
...
void Mesh::Draw() {
	...
	//glBindVertexArray(arrayObject);
	//glDrawArrays(type, 0, numVertices); // 10 tringle mesh numVertices=10
